export const homeObjTemplate = {
    ...
    topLine: 'Sub-heading',
    headLine: 'About Us',
    description: 'A short descriptive statement to lead someone to clicking on Learn More.', 
    
    /* Image Styling */
    imgStart: false, /* alter this property to flip the positioning of the svg and text + button from left to right */
    img: require('../../images/team-work.svg').default, /* Check out link at top of readme in repo for more images like this */
    alt: 'Car',
